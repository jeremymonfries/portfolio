...
skills: ['UX analysis', 'User research', 'Information architecture', 'Visual design']
order: 3
---
...
import responsiveIssueImg from '../../assets/case-studies/blackwoods/07.jpg';
import simpleSolutionImg from '../../assets/case-studies/blackwoods/08.jpg';
import searchIssuesImg from '../../assets/case-studies/blackwoods/09.jpg';
import updatedSearchImg from '../../assets/case-studies/blackwoods/10.jpg';
import megaMenuIssuesImg from '../../assets/case-studies/blackwoods/11.jpg';
import megaMenuUpdateImg from '../../assets/case-studies/blackwoods/12.jpg';
...
<ColumnGrid cols={3}>
<div>
<SectionHeading level="section">Tools</SectionHeading>
...
<div>
<SectionHeading level="section">Skills</SectionHeading>
...
<SectionHeading level="chapter">Competitor analysis</SectionHeading>
...
<SectionHeading level="chapter">Heatmaps</SectionHeading>
...
<SectionHeading level="chapter">Responsive design</SectionHeading>

<MediaRow src={responsiveIssueImg} alt="Responsive layout issue on the existing Blackwoods site at narrow browser widths" reverse>
<SectionHeading level="section">Responsive issue</SectionHeading>
...
<MediaRow src={simpleSolutionImg} alt="Fixed-width layout solution applied to fix the Blackwoods responsive issue" reverse>
<SectionHeading level="section">Simple solution</SectionHeading>
...
<SectionHeading level="chapter">Search results page</SectionHeading>

<MediaRow src={searchIssuesImg} alt="Blackwoods existing search results page">
<SectionHeading level="section">Search results issues</SectionHeading>
...
<MediaRow src={updatedSearchImg} alt="Improved UX for the search results page">
<SectionHeading level="section">Updated search results</SectionHeading>
...
<SectionHeading level="chapter">Mega-menu</SectionHeading>

<MediaRow src={megaMenuIssuesImg} alt="Original mega-menu with no sub-category" reverse>
<SectionHeading level="section">Mega-menu issues</SectionHeading>
...
<MediaRow src={megaMenuUpdateImg} alt="Updated mega-menu with secondary categorisation" reverse>
<SectionHeading level="section">Mega-menu update</SectionHeading>
