...
<DeviceFrame variant="mobile">
  ![Low-fidelity wireframe for the configurable mobile comparison
  chart](../../assets/case-studies/comparison-chart/07.jpg)
</DeviceFrame>
...
<DeviceFrame variant="mobile">
  ![Comparison chart prototype used in qualitative user
  testing](../../assets/case-studies/comparison-chart/08.jpg)
</DeviceFrame>
