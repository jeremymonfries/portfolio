...
tldr: "NortonLifeLock was launching a product aimed specifically at gamers, a customer group with different performance and security needs. I focused on identifying the right gamer persona, shaping the product-page experience and validating the messaging, imagery and purchase information through qualitative testing, while keeping the design aligned with Norton's broader visual language."
heroImage:
  src: '../../assets/case-studies/norton-gamer.jpg'
  alt: 'Norton Gamer project thumbnail'
skills: ['Personas', 'User testing', 'Visual design', 'UI design']
order: 9
---
...
import personasImg from '../../assets/case-studies/norton-gamer/01.jpg';
...
<MediaRow src={personasImg} alt="Sandy and Shaun gamer personas">
<SectionHeading level="section">Personas</SectionHeading>
...
<SectionHeading level="section">Visual design</SectionHeading>
...
![Norton Gamer product page visual design on desktop](../../assets/case-studies/norton-gamer/02.jpg)
</DeviceFrame>

<DeviceFrame variant="mobile">
![Norton Gamer product page visual design on mobile](../../assets/case-studies/norton-gamer/04.jpg)
</DeviceFrame>
</ImageGrid>
